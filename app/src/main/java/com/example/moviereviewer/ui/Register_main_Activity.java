...
public class Register_main_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextPassword2 = (EditText) findViewById(R.id.psw2);
        textViewSignin = (TextView) findViewById(R.id.textViewSignin);

        buttonSignup = (Button) findViewById(R.id.next_regis);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful() && TextUtils.equals(password, password2) == true){
                            ...
                            Toast.makeText(Register_main_Activity.this,"Registration Error",Toast.LENGTH_LONG).show();
                        }
